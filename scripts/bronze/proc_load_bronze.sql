...
BEGIN
	...
	BEGIN TRY
		...
		FROM 'D:\DataWareHouse Project\source_erp\CUST_AZ12.csv'
		WITH (
		   FIRSTROW = 2,
		   FIELDTERMINATOR = ',',
		   TABLOCK 
		...
		FROM 'D:\DataWareHouse Project\source_erp\LOC_A101.csv'
		WITH (
		   FIRSTROW = 2,
		   FIELDTERMINATOR = ',',
		   TABLOCK 
		...
		FROM 'D:\DataWareHouse Project\source_erp\PX_CAT_G1V2.csv'
		WITH (
		   FIRSTROW = 2,
		   FIELDTERMINATOR = ',',
		   TABLOCK 
